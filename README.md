...
Le câble fourni avec le matériel n'a jamais fonctionné sous Windows 10. La connexion est donc assurée au moyen d'un adaptateur USB<->RS232 (RJ45) et d'un câble RJ45<->RJ12.
